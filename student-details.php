		...
		<div class="content-wrapper">
			<div class="container-fluid">
				<div class="row" id="print">
					...
					<div class="col-md-12">
						<h2 class="page-title" style="margin-top:5%">Rooms Details</h2>
...
<td><b>Fees PM :</b></td>
<td><?php $fpm=$row->feespm;
		  echo number_format($row->feespm / 6, 2);?></td>
</tr>
...
<tr><th>Hostel Fee:</th>
<td><?php echo number_format($fpm=$row->feespm);?></td>
<!-- <th>Food Fee:</th> -->
<td colspan="6">
<?php 
// if($row->foodstatus==1)
