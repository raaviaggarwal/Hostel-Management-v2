...
if(isset($_POST['submit']))
{
	...
	if($count>0)
	{
		...
		$query="insert into registration(roomno,seater,feespm,stayfrom,course,regno,firstName,lastName,gender,contactno,emailid,guardianName,guardianRelation,guardianContactno,corresAddress,corresCIty,corresState,corresPincode,pmntAddress,pmntCity,pmnatetState,pmntPincode) values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
		$stmt = $mysqli->prepare($query);
		$rc=$stmt->bind_param('siiissssssssssssssssss',$roomno,$seater,$feespm,$stayfrom,$course,$regno,$fname,$lname,$gender,$contactno,$emailid,$gurname,$gurrelation,$gurcntno,$caddress,$ccity,$cstate,$cpincode,$paddress,$pcity,$pstate,$ppincode);
		$stmt->execute();
		$stmt->close();
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title" style="margin-top:3%">Registration </h2>
