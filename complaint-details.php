...
while($row=$res->fetch_object())
	  {
	  	?>
					<div class="col-md-12">
						<h2 class="page-title" style="margin-top:5%">#<?php echo $row->ComplainNumber;?> Details</h2>
...
<tr>
<td colspan="6" style="text-align:center; color:blue"><h4>Complaint Related Info</h4></td>
</tr>
<tr>
