...
export default function SecurityEntryExit() {
  ...
  const columns = [
    ...
    { title: 'Type', dataIndex: 'type', render: (v) => <StatusTag status={v} /> },
  ...
  return (
    <>
      <PageHeader title="Entry / Exit" subtitle="Biometric gate punches at the main gate." />
      ...
      <Row gutter={[16, 16]} style={{ marginBottom: 16 }}>
        ...
        <Col xs={24} sm={6}>
          <Card size="small">
            <Statistic title="Students Outside" value={summary.outside} valueStyle={{ color: '#C0392B' }} />
          </Card>
        </Col>
      </Row>
      ...
      <Card title="Recent Punches">
        <div style={{ marginBottom: 16 }}>
          <TableSearchBar query={query} onQuery={setQuery} placeholder="Search student or gate..." />
        </div>
